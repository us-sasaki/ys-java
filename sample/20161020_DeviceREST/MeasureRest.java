 ...
 */
	 ...
	 */
	public MeasureRest(String urlStr, String tenant, String user, String password) {
		this.urlStr = urlStr;
		this.tenant = tenant;
		this.user = user;
 ...
 */
	 ...
	 */
	public static MeasureRest getDefaultC8YInstance() {
		return new MeasureRest("https://nttcom.cumulocity.com", "nttcom", "us.sasaki@ntt.com", "nttcomsasaki3");
	}
...
System.out.println("Auth Str " + authStr);
	...
	public void post(String location, String body) throws IOException {
		...
		con.setRequestProperty("Content-Type", "application/vnd.com.nsn.cumulocity.measurement+json; charset=UTF-8; ver=0.9");
		con.setRequestProperty("Accept", "application/vnd.com.nsn.cumulocity.measurement+json; charset=UTF-8; ver=0.9");
		con.setRequestProperty("Authorization", "Basic " + authStr);
...
//		jt.add("c8y_Position", new JsonObject().add("alt",30).add("lat",35.671251).add("lng", 139.757461).add("trackingProtocol","TELIC").add("reportReason","Time Event"));
		MeasureRest r = MeasureRest.getDefaultC8YInstance();
//		MeasureRest r = new MeasureRest("http://localhost:8080", "tenant", "us.sasaki@ntt.com", "nttcomsasaki3");
