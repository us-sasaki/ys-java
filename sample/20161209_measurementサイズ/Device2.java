...
//System.out.println("Step 2: " + resp.code);
...
//		mo.c8y_Position.trackingProtocol = "TELIC";
//		mo.c8y_Position.reportReason = "Time Event";
...
//			sendEvents();
	...
	private void uploadBinary(String filename,
		...
		Rest.Response resp = r.post("/inventory/binaries", filename, mimetype, binary);
...
//		a.cycle();
//		a.uploadBinary("binarySample.txt", "text/plain", "This is a sample binary.\r\nSimple ASCII Text.\r\n".getBytes());
