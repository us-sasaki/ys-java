...
┃　　　　　　　更新箇所。原文を確認し、翻訳文を修正して下さい　　　　　　　┃
┃━━━━━━━━━━ 原文更新前(1)：16行目 ━━━━━━━━━━           ┃
┃|_type|String|The type of the event. See the table below for which 【type ┃
┃values apply】 for 【the】 different streams|                             ┃
┃━━━━━━━━━━ 原文更新後(1)：16行目 ━━━━━━━━━━           ┃
┃|_type|String|The type of the event. See the table below for which        ┃
┃【value types can be used】 for 【】 different streams|                   ┃
┣━━━━━━━━━━━　元の翻訳文(修正して下さい)　━━━━━━━━━━━┫
...
┃　　　　　　　更新箇所。原文を確認し、翻訳文を修正して下さい　　　　　　　┃
┃━━━━━━━━━━ 原文更新前(1)：18行目 ━━━━━━━━━━           ┃
┃|_origin|String|The origin of the event. If the data was created by a cep ┃
┃rule the origin will be 【"cep"|】                                        ┃
┃━━━━━━━━━━ 原文更新後(1)：18行目 ━━━━━━━━━━           ┃
┃|_origin|String|The origin of the event. If the data was created by a cep ┃
┃rule the origin will be 【"cep".|】                                       ┃
┣━━━━━━━━━━━　元の翻訳文(修正して下さい)　━━━━━━━━━━━┫
...
┃　　　　　　　更新箇所。原文を確認し、翻訳文を修正して下さい　　　　　　　┃
┃━━━━━━━━━━ 原文更新前(1)：181行目 ━━━━━━━━━━          ┃
┃When creating 【data】 Cumulocity will 【generated】 an ID if not set in  ┃
┃the event processing. The creation of data also requires certain          ┃
┃parameters to be set (the same as at our REST APIs).                      ┃
┃In addition to the predefined parameters 【listed】 it is possible to add ┃
┃any custom fragment to the data. Please take a look at ---->this<---- for ┃
┃adding custom fragments.                                                  ┃
┃━━━━━━━━━━ 原文更新後(1)：181行目 ━━━━━━━━━━          ┃
┃When creating 【data,】 Cumulocity will 【generate】 an ID if not set in  ┃
┃the event processing. The creation of data also requires certain          ┃
┃parameters to be set (the same as at our REST APIs).                      ┃
┃In addition to the predefined parameters 【listed,】 it is possible to    ┃
┃add any custom fragment to the data. Please take a look at ---->this<---- ┃
┃for adding custom fragments.                                              ┃
┣━━━━━━━━━━━　元の翻訳文(修正して下さい)　━━━━━━━━━━━┫
...
┃　　　　　　　更新箇所。原文を確認し、翻訳文を修正して下さい　　　　　　　┃
┃━━━━━━━━━━ 原文更新前(1)：365行目 ━━━━━━━━━━          ┃
┃It is possible to have more than one mail address in the parameters       ┃
┃receiver,cc and bcc. Therefore create a string that contains all mail     ┃
